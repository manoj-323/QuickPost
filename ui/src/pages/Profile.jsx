...
const Profile = () => {
  ...
  const editProfile = async () => {
    console.log("haven't implemented the edit functionality yet.");
  }
        ...
        <div className="flex flex-grow p-1">
          <div className="scrollable-container bg-[#1c1e21] rounded-3xl p-1 mx-auto text-center overflow-y-auto no-scrollbar pb-12 border border-[#323232] w-[400px] max-h-[88vh]">
            ...
            <div className="flex items-center space-x-6 mb-4 mt-1">
              <img
                src={'http://127.0.0.1:8000/media/profile_picture/default_pfp.png'}
                alt="Profile"
            ...
            <div className="flex justify-center mb-4">
              <button className={`${profileData?.is_following ? 'bg-gray-600' : 'bg-blue-600'} text-white py-2 px-6 rounded-lg shadow-md hover:bg-blue-700 transition duration-200`} onClick={handleFollowOrEdit}>
            ...
            {isFollowersVisible && profileData?.followers?.length > 0 && (
              <div className="mt-4 max-h-52 overflow-auto no-scrollbar">
                <h2 className="text-xl text-white">Follower</h2>
